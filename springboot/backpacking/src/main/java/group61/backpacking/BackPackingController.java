...
public class BackPackingController {
    ...
    // AURORA: 
      ...
      @CrossOrigin(origins = "*")
      @DeleteMapping("/deleteitinerary/{title}")
      public void deleteItinerary(@RequestBody String email, @PathVariable String title) throws RuntimeException, SQLException {
